//* 1.1 Dado el siguiente objeto, cambia el valor de la propiedad age a 25. const character = {name: 'Jack Sparrow', age: 10};*/
...
if (firstName === 'Jon' && lastName === 'Snow' && age === 24) {
  console.log(
...
console.log(`El precio total de los dos juguetes es: ${totalPrice}`)
...
if ((globalBasePrice = 25000)) {
  car1.finalPrice = car1.basePrice + globalBasePrice
  car2.finalPrice = car2.basePrice + globalBasePrice
  console.log(
    `El precio final de los coches será de ${car1.finalPrice} car1 y ${car2.finalPrice} car2`
  )
}
